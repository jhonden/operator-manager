 ...
 * Data Initializer
 *
 * Creates default admin user and categories for development
 *
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (categoryRepository.count() == 0) {
            ...
            String[][] categoryData = {
                {"Data Processing", "Data transformation, cleaning, and processing operators"},
                {"File Operations", "File reading, writing, and manipulation operators"},
                {"Data Validation", "Data quality checks and validation operators"},
                {"Data Transformation", "Data format conversion and transformation operators"},
                {"Database", "Database connection and query operators"},
                {"API", "API integration and HTTP request operators"},
                {"Utility", "Utility and helper operators"}
            };
            ...
            log.info("Default categories created: {} categories", categoryData.length);
        } else {
